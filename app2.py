...
def list_network(network, file):
    ...
    _img = "https://send.papamica.fr/f.php?h=0f3ZrzyN&p=1"
    fields.extend((_name, _type, _option, _ip, _image, _note, _fill, _stroke, _refs, _img))
...
def list_containers(network, file):
    ...
    for container in containers:
        ...
        _image = _container[_name]['Image']
        _note = " ".join(_container[_name]['Ports'])
        ...
        _img = "https://send.papamica.fr/f.php?h=36z5CCnq&p=1"
        fields.extend((_name, _type, _option, _ip, _image, _note, _fill, _stroke, _refs, _img))
        add_csv_line(file, fields)
